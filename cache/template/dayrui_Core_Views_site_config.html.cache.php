        ...
        <div class="portlet-title tabbable-line">
            <ul class="nav nav-tabs" style="float:left;">
                <li class="<?php if ($page==0) { ?>active<?php } ?>">
                    <a href="#tab_0" data-toggle="tab" onclick="$('#dr_page').val('0')"> <i class="fa fa-globe"></i> <?php echo dr_lang('站点信息'); ?> </a>
                </li>
                <li class="<?php if ($page==3) { ?>active<?php } ?>">
                    <a href="#tab_3" data-toggle="tab" onclick="$('#dr_page').val('3')"> <i class="fa fa-cog"></i> <?php echo dr_lang('参数设置'); ?> </a>
                </li>
                <li class="<?php if ($page==1) { ?>active<?php } ?>">
                    <a href="#tab_1" data-toggle="tab" onclick="$('#dr_page').val('1')"> <i class="fa fa-share-alt-square"></i> <?php echo dr_lang('域名设置'); ?> </a>
                </li>
            </ul>
        </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane <?php if ($page==0) { ?>active<?php } ?>" id="tab_0">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="checkbox" name="data[SITE_INDEX_HTML]" value="1" <?php if ($data['SITE_INDEX_HTML']) { ?>checked<?php } ?> data-on-text="<?php echo dr_lang('开启'); ?>" data-off-text="<?php echo dr_lang('关闭'); ?>" data-on-color="success" data-off-color="danger" class="make-switch" data-size="small">
                                <span class="help-block"><?php echo dr_lang('开启之后首页将会自动生成静态文件'); ?></span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo dr_lang('网站LOGO'); ?></label>
                            <div class="col-md-9">
                                <?php echo $logofield; ?>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <label><input class="form-control input-large" type="text" name="data[SITE_NAME]" id="dr_name" value="<?php echo $data['SITE_NAME']; ?>"></label>
                             </div>
                        </div>
                        <div class="form-group">
                        ...
                        <?php if ($my_site_info) {  if ($fn_include = $this->_load("$my_site_info")) include($fn_include);  } ?>
                        <div class="form-group ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <label><select class="form-control" name="data[SITE_LANGUAGE]">
                                    ...
                                    <?php if (is_array($lang)) { $key_t=-1;$count_t=dr_count($lang);foreach ($lang as $t) { $key_t++; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <label><select class="form-control" name="data[SITE_TEMPLATE]">
                                    <option value="default"> -- </option>
                                    <?php if (is_array($template_path)) { $key_t=-1;$count_t=dr_count($template_path);foreach ($template_path as $t) { $key_t++; ?>
                ...
                <div class="tab-pane  <?php if ($page==1) { ?>active<?php } ?>" id="tab_1">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo dr_lang('网站域名'); ?></label>
                            <div class="col-md-4">
                                <div class="input-group" style="width: 300px;">
                                    <input type="text" <?php if (SITE_ID == 1) { ?> readonly<?php } ?> name="data[SITE_DOMAIN]" id="dr_domain" value="<?php echo $data['SITE_DOMAIN']; ?>" class="form-control">
                                ...
                                <span class="help-block" id="dr_domain_tips"><?php echo dr_lang('例如：www.test.com，不能包含/符号'); ?></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo dr_lang('其他域名'); ?></label>
                            <div class="col-md-9">
